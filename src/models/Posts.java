...
//        Query namedQuery = entitymanager.createNativeQuery("select p.* from post_likes pl, posts p" +
...
//        var post = new Posts(user2, "5435345", "123123123");
//        System.out.println(Posts.createPost(post));
//        var posts = (Posts) Posts.getPostsOfUser("asd").get(0);
//        var postlike = new PostLikes(posts, user4.getUsername(),user2.getUsername());
//
//        System.out.println(PostLikes.addLike(postlike));
